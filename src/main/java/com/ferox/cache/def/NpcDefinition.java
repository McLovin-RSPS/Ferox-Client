...
public final class NpcDefinition {
    ...
    public Model get_animated_model(int animation, int current, int[] label) {
        ...
        if (model == null) {
            ...
            model.skin();
            model.light(84 + ambient, 1000 + contrast, -90, -580, -90);
        ...
        animated_model.calculateDistances();
    ...
    public void decode(Buffer buffer) {
        while (true) {
            ...
            if (opcode == 0) {
                ...
                rotateLeftAnimation = buffer.readUShort(); //rotate left anim
            } else if (opcode == 16) {
                rotateRightAnimation  = buffer.readUShort(); //rotate right anim
            } else if (opcode == 17) {
                walkingAnimation = buffer.readUShort();
    ...
    public int id;
    public static TempCache model_cache = new TempCache(75);
