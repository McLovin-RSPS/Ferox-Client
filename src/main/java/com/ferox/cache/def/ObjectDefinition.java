...
public final class ObjectDefinition {
    ...
    public void decode(Buffer buffer) {
        do {
            ...
            if (opcode == 1) {
                ...
                scene_actions[opcode - 30] = buffer.readStrings();
                ...
                contour_to_tile = buffer.readUnsignedByte() >= 0;
            } else if (opcode == 82) {
                buffer.readUShort();
            } else if(opcode == 89) {
    ...
    public ObjectDefinition get_configs() {
        ...
        if (varbit_id != -1) {
            ...
            setting_id = Client.instance.settings[varp_id];
    ...
    public Model get_animated_model(int type, int animation_id, int orientation) {
        ...
        animated_model.light(60 + this.ambient, 768 + this.contrast, -50, -10, -50); // LocoPk
        if (merge_interact_state == 1) {
    ...
    public static TempCache animated_model_cache = new TempCache(75);
