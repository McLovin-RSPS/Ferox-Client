...
public class TeleportWidget extends Widget {
    ...
    public static void handleTeleportTab(int index) {
        ...
        if (index == TELEPORT_CATEGORY_PVP) {
            ...
            newIDS = new int[]{1031, 1030, 1029, 1028, 1027, 1026, 1025, 1024, 1023, 1021, 1020, 1018, 1017, 1016, 1042, 1044, 1015, 1104, 1019, 1022, 1447, 1758, 1795, 1819};
            newNames = new String[]{"  Callisto", "   Cerberus", "   Chaos Fan", "  Corp Beast", "  Crazy Arch", "  Dagg Kings", "Demon Gorillas", "         GWD", "         KBD", "     Kraken", "     Shaman", "     Thermo", "   Venenatis", "      Vet'ion", "      Scorpia", "   Chaos Ele", "      Zulrah", "   Vorkath", "   World boss", "          KQ", "Giant Mole", "Alchy Hydra", "Barrelchest", "Raids Area"};
            widget.totalChildren(newIDS.length * 2);
            //System.out.println("Widget length: " + widget.children.length);
            xPos = 35;
            yPos = 0;
