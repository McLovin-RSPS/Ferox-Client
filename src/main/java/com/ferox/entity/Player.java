...
public final class Player extends Entity implements net.runelite.api.Player {
    ...
    public void update(Buffer buffer) {
        ...
        Client.instance.getCallbacks().post(new PlayerChanged(this));
    }
    ...
    public RSPlayerComposition getPlayerComposition() {
        return new RSPlayerComposition() {
            ...
            public int getKitId(KitType type) {
                return appearance_colors[type.getIndex()];
            }
        };
    }
