...
public class ModelLoader {
    ...
    public static void decodeType3(Model def, byte[] var1)
    {
        ...
        if (var11 > 0)
        {
            def.texture_map = new byte[var11];
            var2.setOffset(0);

            for (var28 = 0; var28 < var11; ++var28)
            {
                byte var29 = def.texture_map[var28] = var2.readSignedByte();
                if (var29 == 0)
                {
                    ++var25;
                }
        ...
        def.vertices = var9;
        def.faces = var10;
        def.texture_faces = var11;
        def.vertex_x = new int[var9];
        def.vertex_y = new int[var9];
        def.vertex_z = new int[var9];
        def.triangle_edge_a = new int[var10];
        def.triangle_edge_b = new int[var10];
        def.triangle_edge_c = new int[var10];
        if (var17 == 1)
        {
            def.bone_skin = new int[var9];
        }

        if (var12 == 1)
        {
            def.render_type = new int[var10];
        }
        ...
        if (var15 == 1)
        {
            def.muscle_skin = new int[var10];
        }

        if (var16 == 1)
        {
            def.materials = new int[var10];
        }
        ...
        for (var51 = 0; var51 < var9; ++var51)
        {
            ...
            def.vertex_x[var51] = var48 + var53;
            def.vertex_y[var51] = var49 + var54;
            def.vertex_z[var51] = var50 + var55;
            var48 = def.vertex_x[var51];
            var49 = def.vertex_y[var51];
            var50 = def.vertex_z[var51];
            if (var17 == 1)
            {
                def.bone_skin[var51] = var6.readUnsignedByte();
            }
        }
        ...
        {
            def.face_color[var51] = (short) var2.readUShort();
            if (var12 == 1)
            {
                def.render_type[var51] = var3.readSignedByte();
            }
            ...
            if (var15 == 1)
            {
                def.muscle_skin[var51] = var6.readUnsignedByte();
            }
        ...
        for (var55 = 0; var55 < var10; ++var55)
        {
            ...
            if (var56 == 1)
            {
                ...
                var54 = var53;
                def.triangle_edge_a[var55] = var51;
                def.triangle_edge_b[var55] = var52;
                def.triangle_edge_c[var55] = var53;
            }
            ...
            if (var56 == 4)
            {
                ...
                var54 = var53;
                def.triangle_edge_a[var55] = var51;
                def.triangle_edge_b[var55] = var57;
                def.triangle_edge_c[var55] = var53;
            }
        }
        ...
        {
            var56 = def.texture_map[var55] & 255;
            if (var56 == 0)
            {
    ...
    public static void decodeType2(Model def, byte[] var1)
    {
        ...
        for (var40 = 0; var40 < var9; ++var40)
        {
            ...
            def.vertex_x[var40] = var37 + var42;
            def.vertex_y[var40] = var38 + var43;
            def.vertex_z[var40] = var39 + var44;
            var37 = def.vertex_x[var40];
            var38 = def.vertex_y[var40];
            var39 = def.vertex_z[var40];
            if (var16 == 1)
            {
                def.bone_skin[var40] = var8.readUnsignedByte();
            }
        }
        ...
        {
            def.face_color[var40] = (short) var4.readUShort();
            if (var12 == 1)
            {
                var41 = var5.readUnsignedByte();
                if ((var41 & 1) == 1)
                {
                    def.render_type[var40] = 1;
                    var2 = true;
                }
                else
                {
                    def.render_type[var40] = 0;
                }

                if ((var41 & 2) == 2)
                {
                    def.textures[var40] = (byte) (var41 >> 2);
                    def.materials[var40] = def.face_color[var40];
                    def.face_color[var40] = 127;
            ...
            if (var15 == 1)
            {
                def.muscle_skin[var40] = var8.readUnsignedByte();
            }
        }
        ...
        for (var44 = 0; var44 < var10; ++var44)
        {
            ...
            if (var45 == 1)
            {
                ...
                var43 = var42;
                def.triangle_edge_a[var44] = var40;
                def.triangle_edge_b[var44] = var41;
                def.triangle_edge_c[var44] = var42;
            }
            ...
            if (var45 == 4)
            {
                ...
                var43 = var42;
                def.triangle_edge_a[var44] = var40;
                def.triangle_edge_b[var44] = var46;
                def.triangle_edge_c[var44] = var42;
            }
        }
        ...
        if (def.textures != null)
        {
            ...
            for (var45 = 0; var45 < var10; ++var45)
            {
                ...
                if (var46 != 255)
                {
                    if (def.triangle_edge_a[var45] == (def.texturesX[var46] & '\uffff') && def.triangle_edge_b[var45] == (def.texturesY[var46] & '\uffff') && def.triangle_edge_c[var45] == (def.texturesZ[var46] & '\uffff'))
                    {
    ...
    public static void decodeType1(Model def, byte[] var1)
    {
        ...
        if (var11 > 0)
        {
            ...
            {
                byte var27 = def.texture_map[var26] = var2.readSignedByte();
                if (var27 == 0)
                {
                    ++var23;
                }
        ...
        for (var49 = 0; var49 < var9; ++var49)
        {
            ...
            def.vertex_x[var49] = var46 + var51;
            def.vertex_y[var49] = var47 + var52;
            def.vertex_z[var49] = var48 + var53;
            var46 = def.vertex_x[var49];
            var47 = def.vertex_y[var49];
            var48 = def.vertex_z[var49];
            if (var17 == 1)
            {
                def.bone_skin[var49] = var6.readUnsignedByte();
            }
        }
        ...
        {
            def.face_color[var49] = (short) var2.readUShort();
            if (var12 == 1)
            {
                def.render_type[var49] = var3.readSignedByte();
            }
            ...
            if (var15 == 1)
            {
                def.muscle_skin[var49] = var6.readUnsignedByte();
            }
        ...
        for (var53 = 0; var53 < var10; ++var53)
        {
            ...
            if (var54 == 1)
            {
                ...
                var52 = var51;
                def.triangle_edge_a[var53] = var49;
                def.triangle_edge_b[var53] = var50;
                def.triangle_edge_c[var53] = var51;
            }
            ...
            if (var54 == 4)
            {
                ...
                var52 = var51;
                def.triangle_edge_a[var53] = var49;
                def.triangle_edge_b[var53] = var55;
                def.triangle_edge_c[var53] = var51;
            }
        }
        ...
        {
            var54 = def.texture_map[var53] & 255;
            if (var54 == 0)
            {
    ...
    public static void decodeOldFormat(Model def, byte[] var1)
    {
        ...
        for (var38 = 0; var38 < var9; ++var38)
        {
            ...
            def.vertex_x[var38] = var35 + var40;
            def.vertex_y[var38] = var36 + var41;
            def.vertex_z[var38] = var37 + var42;
            var35 = def.vertex_x[var38];
            var36 = def.vertex_y[var38];
            var37 = def.vertex_z[var38];
            if (var16 == 1)
            {
                def.bone_skin[var38] = var8.readUnsignedByte();
            }
        }
        ...
        {
            def.face_color[var38] = (short) var4.readUShort();
            if (var12 == 1)
            {
                var39 = var5.readUnsignedByte();
                if ((var39 & 1) == 1)
                {
                    def.render_type[var38] = 1;
                    var2 = true;
                }
                else
                {
                    def.render_type[var38] = 0;
                }

                if ((var39 & 2) == 2)
                {
                    def.textures[var38] = (byte) (var39 >> 2);
                    def.materials[var38] = def.face_color[var38];
                    def.face_color[var38] = 127;
            ...
            if (var15 == 1)
            {
                def.muscle_skin[var38] = var8.readUnsignedByte();
            }
        }
        ...
        for (var42 = 0; var42 < var10; ++var42)
        {
            ...
            if (var43 == 1)
            {
                ...
                var41 = var40;
                def.triangle_edge_a[var42] = var38;
                def.triangle_edge_b[var42] = var39;
                def.triangle_edge_c[var42] = var40;
            }
            ...
            if (var43 == 4)
            {
                ...
                var41 = var40;
                def.triangle_edge_a[var42] = var38;
                def.triangle_edge_b[var42] = var44;
                def.triangle_edge_c[var42] = var40;
            }
        }
        ...
        if (def.textures != null)
        {
            ...
            for (var43 = 0; var43 < var10; ++var43)
            {
                ...
                if (var44 != 255)
                {
                    if (def.texturesX[var43] == (def.texturesX[var44] & '\uffff') && def.texturesY[var43] == (def.texturesY[var44] & '\uffff') && def.texturesZ[var43] == (def.texturesZ[var44] & '\uffff'))
                    {
