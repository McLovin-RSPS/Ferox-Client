...
public final class SignLink implements Runnable {
    ...
    public static String findCacheDir() {
        if (ClientConstants.production) {
            ...
            String cacheName = ".AncestralCache/";
            ...
            final File cacheDirectory = new File("./.Ancestral/");
    ...
    public static String findDataDir() {
        if (ClientConstants.production) {
            ...
            final File cacheDirectory = new File("./.ancestral-data/");
            if (!cacheDirectory.exists())
                cacheDirectory.mkdir();
            return "./.ancestral-data/";
        }
        return null;
    }
