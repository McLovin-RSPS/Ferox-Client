...
public final class ItemEquipmentStats
{
    ...
    public boolean equals(final Object o) {
        ...
        if (this.isTwoHanded() != other.isTwoHanded()) return false;
    ...
    public int hashCode() {
        ...
        result = result * PRIME + (this.isTwoHanded() ? 79 : 97);
    ...
    public static class ItemEquipmentStatsBuilder {
        ...
        public ItemEquipmentStats build() {
            return new ItemEquipmentStats(slot, isTwoHanded, astab, aslash, acrush, amagic, arange, dstab, dslash, dcrush, dmagic, drange, str, rstr, mdmg, prayer, aspeed);
        }
